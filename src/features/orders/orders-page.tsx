...
export function OrdersPage() {
  ...
  const handleViewDetails = (order: Order) => {
    // Navigate to order detail page using custom router
    if (typeof window !== "undefined" && (window as any).navigate) {
      (window as any).navigate(`/order/${order.id}`);
    }
  };
  ...
  // Sidebar sections for Orders (part of Account area)
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8">
            ...
            <aside className="space-y-6 relative">
              ...
              <SectionSidebar sections={sidebarSections} />
            </aside>
